...
export default function GioiThieuVinasafe() {
    return (
        <main className="bg-slate-50">
            ...
            <BlueBanner title="Giới thiệu Công ty VINASAFE" description="Thông tin tổng quan, chức năng - nhiệm vụ và cơ cấu tổ chức của Công ty VINASAFE" />
                    ...
                    <div className="space-y-6 text-gray-700">
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-1">
                                ...
                                <li>Chai chứa khí.</li>
                                <li>Thiết bị nâng, thang máy, thang cuốn.</li>
                                <li>Cẩu tháp, vận thăng lồng, tời nâng người, hệ thống cốt pha trượt.</li>
                                <li>Cần cẩu bánh lốp, bánh xích, cẩu cảng.</li>
                                <li>Kiểm định hệ thống chống sét.</li>
                                <li>Kiểm định an toàn hệ thống điện.</li>
                                <li>Kiểm định an toàn các thiết bị công nghiệp, xây dựng và dân dụng.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-1">
                                ...
                                <li>Kiểm tra không phá hủy như siêu âm, chụp ảnh bức xạ, bột từ, bột thẩm thấu cho các kết cấu kim loại và mối hàn.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                Chứng nhận hợp chuẩn, hợp quy cho mẫu sản phẩm hoặc sản phẩm là 
                                thiết bị có yêu cầu nghiêm ngặt về an toàn lao động, bao gồm: nồi hơi; 
                                bình chịu áp lực; chai chứa khí; thiết bị nâng; thang máy; thang cuốn, băng tải chở người.
                            </p>
                        </div>
